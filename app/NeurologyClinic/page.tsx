      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto">
          ...
          <div className="space-y-2">
            ...
            <Input id="healthGoals" placeholder="Describe your neurological symptoms" value={formData.healthGoals} onChange={handleInputChange} />
          </div>
          <div className="space-y-2">
            <Label>Select Doctor</Label>
            <Select required value={formData.doctor} onValueChange={handleSelectChange}>
              <SelectTrigger><SelectValue placeholder="Choose a neurologist" /></SelectTrigger>
              <SelectContent>
                <SelectItem value="ahmed-khan">Dr. Ahmed Khan</SelectItem>
                <SelectItem value="sana-rafiq">Dr. Sana Rafiq</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div className="space-y-2">
