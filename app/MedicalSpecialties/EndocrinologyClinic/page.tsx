    ...
    <div className="max-w-6xl mx-auto px-4 py-12 md:py-20 relative">
      ...
      <motion.section initial="hidden" animate="show" variants={{ hidden: { opacity: 0 }, show: { opacity: 1, transition: { staggerChildren: 0.1 } } }} className="text-center mb-16">
        ...
        <motion.p variants={{ hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0, transition: { duration: 0.5 } } }} className="text-lg text-gray-600">
          Specialized care for hormonal disorders and metabolic conditions
        </motion.p>
      </motion.section>
      ...
      <motion.section initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="bg-blue-50 rounded-xl p-6 mb-16">
        <h2 className="text-2xl font-semibold text-blue-800 mb-4">Our Endocrinology Services</h2>
        <p className="text-gray-700">
          Our endocrinology specialists provide comprehensive care for diabetes, thyroid disorders, hormonal imbalances, osteoporosis, and other metabolic conditions.
        </p>
      </motion.section>

      {/* Doctors */}
      <section className="mb-16">
        <h2 className="text-3xl font-bold text-center text-blue-800 mb-12">Our Endocrinology Specialists</h2>
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <motion.div whileHover={{ y: -5 }} transition={{ duration: 0.3 }} className="relative">
            <Card className="hover:shadow-xl transition-all duration-300 overflow-hidden">
              <div className="relative h-64 w-full">
                <Image
                  src="/Dr-Rahul-Endocrinology.webp"
                  alt="Dr. Rahul Mehta"
                  fill
              ...
              <CardHeader>
                <CardTitle className="text-blue-700">Dr. Rahul Mehta</CardTitle>
                <CardDescription className="italic text-gray-600">
                  MD, Endocrinology Specialist
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-700">
                  Dr. Mehta specializes in diabetes management, thyroid disorders, and hormonal imbalances with over 15 years of experience.
                </p>
                <p className="mt-4 font-medium">
                  <span className="text-blue-600">Specialties:</span> Diabetes, Thyroid Disorders, Pituitary Disorders, Metabolic Syndrome
                </p>
              </CardContent>
            </Card>
          </motion.div>
          <motion.div whileHover={{ y: -5 }} transition={{ duration: 0.3 }} className="relative">
            <Card className="hover:shadow-xl transition-all duration-300 overflow-hidden">
              <div className="relative h-64 w-full">
                <Image
                  src="/Dr-Priya-Endocrinology.webp"
                  alt="Dr. Priya Sharma"
                  fill
                  className="object-cover transition-all duration-500 hover:scale-105"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
              ...
              <CardHeader>
                <CardTitle className="text-blue-700">Dr. Priya Sharma</CardTitle>
                <CardDescription className="italic text-gray-600">
              ...
              <CardContent>
                <p className="text-gray-700">
                  Dr. Sharma focuses on childhood diabetes, growth disorders, and puberty-related hormonal issues.
                </p>
                <p className="mt-4 font-medium">
                  <span className="text-blue-600">Specialties:</span> Pediatric Diabetes, Growth Disorders, Puberty Disorders, Childhood Obesity
                </p>
              </CardContent>
            </Card>
          </motion.div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto">
          ...
          <div className="space-y-2">
            ...
            <Select required value={formData.doctor} onValueChange={handleSelectChange}>
              ...
              <SelectContent>
                <SelectItem value="dr-rahul">Dr. Rahul Mehta (Adult Endocrinology)</SelectItem>
                <SelectItem value="dr-priya">Dr. Priya Sharma (Pediatric Endocrinology)</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div className="space-y-2">
      ...
      <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="mt-16 bg-white rounded-xl p-8 shadow-sm">
        <h2 className="text-2xl font-bold text-center text-blue-800 mb-8">Common Endocrine Conditions We Treat</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-blue-700">Diabetes</CardTitle>
            </CardHeader>
            <CardContent>
              <p>Type 1, Type 2, and gestational diabetes management with personalized treatment plans.</p>
            </CardContent>
          </Card>
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-blue-700">Thyroid Disorders</CardTitle>
            </CardHeader>
            <CardContent>
              <p>Hypothyroidism, hyperthyroidism, thyroid nodules, and thyroid cancer evaluation.</p>
            </CardContent>
          </Card>
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-blue-700">Hormonal Imbalances</CardTitle>
            </CardHeader>
            <CardContent>
              <p>PCOS, adrenal disorders, pituitary disorders, and reproductive hormone issues.</p>
            </CardContent>
          </Card>
        </div>
      </motion.section>
