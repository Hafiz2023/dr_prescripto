...
export default function NutritionClinic() {
  ...
  const handleSelectChange = (value: string) => {
    setFormData(prev => ({ ...prev, dietitian: value }));
  };
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 md:py-20 relative">
      ...
      >
        ...
        >
          Evidence-based dietary guidance for optimal health and wellbeing
        </motion.p>
      </motion.section>
      ...
      >
        ...
        <p className="text-gray-700">
          ...
          and personalized meal planning. Our registered dietitians provide 
          science-based recommendations tailored to your unique needs and lifestyle.
        </p>
      </motion.section>
        ...
        >
          ...
          >
            <Card className="hover:shadow-xl transition-all duration-300 overflow-hidden">
              ...
              <CardContent>
                <p className="text-gray-700">
                  Specializing in diabetes management and metabolic health, 
                  Dr. Rodriguez combines clinical expertise with practical 
          ...
          >
            <Card className="hover:shadow-xl transition-all duration-300 overflow-hidden">
              ...
              <CardContent>
                <p className="text-gray-700">
                  With experience working with professional athletes, James 
                  provides performance nutrition strategies to help clients 
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto">
          ...
          <div className="space-y-2">
            ...
            <Select required value={formData.dietitian} onValueChange={handleSelectChange}>
              <SelectTrigger>
