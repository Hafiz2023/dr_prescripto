// app/infectious-diseases/page.tsx
"use client";
...
export default function InfectiousDiseasesClinic() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 md:py-20 relative">
      ...
      <motion.section initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="bg-blue-50 rounded-xl p-6 mb-16">
        <h2 className="text-2xl font-semibold text-blue-800 mb-4">Our Infectious Diseases Services</h2>
        <p className="text-gray-700">
          We specialize in the diagnosis and treatment of infectious diseases, including bacterial, viral, fungal, and parasitic infections. Our team provides comprehensive care to manage both acute and chronic infections.
        </p>
      </motion.section>

      {/* Doctors */}
      <section className="mb-16">
        <h2 className="text-3xl font-bold text-center text-blue-800 mb-12">Our Infectious Diseases Specialists</h2>
          ...
          <motion.div whileHover={{ y: -5 }} transition={{ duration: 0.3 }} className="relative">
            <Card className="hover:shadow-xl transition-all duration-300 overflow-hidden">
              <div className="relative h-64 w-full">
                <Image
                  src="/Dr-Ali-Infectious-Diseases.webp"
                  alt="Dr. Ali Khan"
                  fill
              ...
              <CardHeader>
                <CardTitle className="text-blue-700">Dr. Ali Khan</CardTitle>
              ...
              <CardContent>
                <p className="text-gray-700">
                  Dr. Khan specializes in the treatment of infectious diseases, including HIV, tuberculosis, and tropical diseases.
                </p>
                <p className="mt-4 font-medium">
                  <span className="text-blue-600">Specialties:</span> HIV, Tuberculosis, Tropical Diseases, Antimicrobial Therapy
                </p>
              </CardContent>
            </Card>
          </motion.div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto">
          ...
          <div className="space-y-2">
            ...
            <Select required value={formData.doctor} onValueChange={handleSelectChange}>
              ...
              <SelectContent>
                <SelectItem value="dr-ali">Dr. Ali Khan</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div className="space-y-2">
